...
print("==================KORELASI LUAS TANAH TERHADAP HARGA LISTRIK===================")
# buat datasetnya
...
simpangan_baku_x = math.sqrt(variance(df['tanah'], mean_x))
simpangan_baku_y = math.sqrt(variance(df['harga'], mean_y))
print(f'Standar Deviasi atau Simpangan Baku Variabel Tanah \t = {simpangan_baku_x}')
print(f'Standar Deviasi atau Simpangan Baku Variabel Biaya Listrik \t = {simpangan_baku_y}')

print("===============================================================================")
print("HASIL")
# hitung korelasi
R = covariance_x_y / (simpangan_baku_x * simpangan_baku_y)
Rxy = str(R)

print("Nilai R = " + Rxy)

if (R>=0):
    print("Jenis hubungan = Positif")
else:
    print("Jenis hubungan = Negatif")
...
kontribusi = R**2*100
print("Besar Kontribusi Luas Tanah terhadap Harga Listrik = ", kontribusi, "%")

perubahan = R**2*100
print("Besar Perubahan yang terjadi pada Harga listrik dipengaruhi oleh Luas Tanah = ", perubahan, "%")

sisa = 100-(R**2*100)
print("Sisa ", sisa, "% merupakan kontribusi dari variabel selain Luas Tanah")
